...
<body>
    <div class="registration-container">
        <h2>Sign Up</h2>
		<form id="registrationForm" name="registrationForm" method="post" action="signup">
		    ...
		    <div class="form-group">
		        ...
		        <input type="tel" id="UserPhone" name="UserPhone" placeholder="Phone Number" pattern="[0-9]{10}" required>
		    </div>
		    <div class="form-group">
		    ...
		    <div class="form-group">
		        ...
		        <input type="text" id="UserAddressLine1" name="UserAddressLine1" placeholder="Address Line 1 (Society/Locality)" required>
		    </div>
		    <div class="form-group">
		        <i class="fas fa-building"></i>
		        <input type="text" id="UserAddressLine2" name="UserAddressLine2" placeholder="Address Line 2 (Town/Area)" required>
		    </div>
		    <div class="form-group">
		    ...
		    <div class="form-group">
		        ...
		        <input type="text" id="UserPincode" name="UserPincode" placeholder="Pincode" pattern="[0-9]{6}" maxlength="6" required>
		    </div>
		    <div class="form-group">
		    ...
		    <div class="form-group">
		        ...
		        <input type="password" id="UserPassword" name="UserPassword" placeholder="Create Password" required>
		    </div>
		    <div class="form-group">
 ...
 <script>
    document.getElementById('UserPincode').addEventListener('input', function(e) {
    ...
    document.getElementById('UserConfirmPassword').addEventListener('input', validatePassword);
